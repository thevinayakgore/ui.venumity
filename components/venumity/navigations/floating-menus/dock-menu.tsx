...
export default function DockMenu() {
  ...
  return (
    <main className="flex items-end space-x-2 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-2xl px-4 py-3 shadow-xl">
      {dockItems.map((item) => (
        <button
          key={item.label}
