...
export default function Faq1() {
  ...
  return (
    <section className="relative flex w-full flex-col items-center justify-center py-5 h-max">
      <div className="container m-auto flex min-h-screen w-full flex-col items-center justify-center p-3 lg:p-5 h-full">
        {/* Header */}
        <motion.div
        ...
        <motion.div
          ...
          className="from-primary/30 via-primary/10 to-primary/5 border-primary/30 group relative m-auto mt-10 flex w-full flex-col items-center justify-center overflow-hidden rounded-xl border bg-linear-to-tl px-8 py-12 text-center shadow-[0_0_45px_10px_hsl(var(--primary)/0.15)] transition-all duration-500 hover:shadow-[0_0_45px_10px_hsl(var(--primary)/0.2)]"
        >
          <BorderBeam
            duration={12}
            size={300}
          ...
          <div className="z-10">
            ...
            <button className="from-primary to-primary/60 relative z-1 cursor-pointer overflow-hidden rounded-md bg-linear-to-tl px-8 py-3 font-medium text-white transition-all duration-700 before:absolute before:top-0 before:left-full before:h-full before:w-full before:rotate-45 before:bg-[linear-gradient(90deg,transparent,rgba(255,255,255,0.2),transparent)] before:transition-all before:duration-700 hover:scale-110 hover:px-12 hover:shadow-[0_0_20px_hsl(var(--primary)/0.4)] hover:before:left-full">
              Get in Touch
            </button>
          </div>
