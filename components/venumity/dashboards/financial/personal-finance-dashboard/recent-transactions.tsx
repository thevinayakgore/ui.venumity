    ...
    <>
      <Card className="bg-background gap-0 overflow-hidden rounded-lg p-0 shadow-none">
        ...
        <CardContent className="p-0">
          <div className="max-h-100 space-y-3 overflow-auto p-3">
            {transactions.map((transaction) => (
              <div
                key={transaction.id}
                className="group flex items-center justify-between rounded-md border bg-linear-to-r from-secondary/30 hover:border-primary/50 p-2"
              >
