...
export default function ProductOverviewBento() {
  return (
    <div className="p-5 w-full">
      <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 lg:grid-rows-3 border rounded-2xl overflow-hidden w-full">
        {/* Card 1: Large Featured (Spans 2 cols, 2 rows) */}
        <motion.div
          variants={itemVariants}
          className="md:col-span-2 md:row-span-2 relative group overflow-hidden transition-all duration-500"
        >
          ...
          <div className="absolute inset-0 p-6 flex flex-col justify-between z-10">
            ...
            <div className="relative h-70 w-full mt-6 rounded-t-xl bg-background overflow-hidden flex items-center justify-center">
              {/* Decorative Chart UI */}
        ...
        <motion.div
          variants={itemVariants}
          className="md:col-span-1 md:row-span-2 relative group bg-accent dark:bg-card flex flex-col overflow-hidden transition-all duration-500"
        >
        ...
        <motion.div
          variants={itemVariants}
          className="md:col-span-1 md:row-span-1 relative group bg-linear-to-br from-indigo-500 to-purple-600 overflow-hidden shadow-lg shadow-indigo-500/20 p-6 flex flex-col justify-between text-white transition-all duration-500"
        >
          <div className="absolute -top-20 -right-20 p-6 rotate-12 text-white size-70">
        ...
        <motion.div
          variants={itemVariants}
          className="md:col-span-1 md:row-span-1 relative group bg-linear-to-b from-accent dark:from-card to-transparent overflow-hidden p-6 flex flex-col justify-center items-center text-center transition-all duration-500"
        >
        ...
        <motion.div
          variants={itemVariants}
          className="md:col-span-1 md:row-span-1 relative group bg-linear-to-tr from-green-500/30 via-green-500/5 to-transparent overflow-hidden p-6 flex items-start transition-all duration-500"
        >
          <div className="flex-1">
            <div className="inline-flex items-center gap-1.5 pr-3 p-2 rounded-full bg-green-500 text-white text-sm font-bold text-shadow-lg/5 mb-6 shadow-lg/5">
              <Globe className="size-5" /> Global Edge Network
            </div>
        ...
        <motion.div
          variants={itemVariants}
          className="md:col-span-3 md:row-span-1 relative group bg-foreground/5 overflow-hidden p-5 flex flex-col transition-all duration-500"
        >
          <div className="flex flex-col md:flex-row gap-4 items-start w-full h-full">
            {/* Terminal Mockup */}
            <div className="bg-background shadow-lg/5 rounded-xl p-5 border transition-all duration-500 md:w-1/2 w-full h-full">
            ...
            <div className="w-full md:w-1/2">
              ...
              <p className="text-sm text-foreground/70 mb-4">
                ...
                molestiae unde officia totam doloribus voluptates aspernatur
                natus a odio. Maiores animi quae alias reiciendis, ipsa eveniet
