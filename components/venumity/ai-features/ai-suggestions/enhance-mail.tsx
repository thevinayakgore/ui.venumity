...
export default function EnhanceMail() {
    ...
    <TooltipProvider>
      <main className="flex items-center justify-center m-auto p-10 md:p-20 overflow-auto min-h-screen">
        <div className="max-w-3xl mx-auto w-full">
          ...
          <div className="rounded-3xl shadow-lg border-8 overflow-hidden">
            {/* Header */}
            ...
            {showCompose && (
              ...
              >
                ...
                <div className="px-4 py-3">
                  ...
                  {/* Formatting Toolbar */}
                  <div className="flex items-center gap-1 p-1 mt-2 bg-foreground/5 rounded-md w-fit">
                    <Tooltip>
                ...
                <div className="px-4 py-2 bg-foreground/5 border-t flex items-center justify-between">
                  <div className="flex items-center gap-1.5">
                    ...
                    <Button
                      ...
                      disabled={
                        !composeContent.trim() || !composeSubject.trim()
                      }
