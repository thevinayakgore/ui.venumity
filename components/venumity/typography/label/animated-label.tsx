...
import { Tag, Sparkles, Zap, RotateCw, TrendingUp, CirclePlus } from "lucide-react";
...
const animatedLabels: AnimatedLabel[] = [
  {
    id: "pulse",
    label: "Live",
    animation: "pulse",
...
export default function LabelAnimated() {
  const [selectedLabel, setSelectedLabel] = useState(0);
  const [speed, setSpeed] = useState(1);
  const [showAll, setShowAll] = useState(false);

  const renderAnimatedLabel = (label: AnimatedLabel) => {
    const baseClasses = `inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-medium ${label.color}`;
            ...
            <div className="mb-6">
              ...
              {showAll ? (
                <div className="flex flex-wrap gap-4">
                  {animatedLabels.map((label) => (
                    <div
                      key={label.id}
                      className="flex flex-col items-center gap-2"
                    >
                      {renderAnimatedLabel(label)}
                ...
                <div className="flex flex-col items-center gap-6">
                  <div className="text-center">
                    {renderAnimatedLabel(animatedLabels[selectedLabel])}
                  </div>
                  <p className="text-gray-600 dark:text-gray-400 text-center">
                    This label has a &quot;{animatedLabels[selectedLabel].animation}&ldquo;
                    animation effect
                  </p>
                </div>
              )}
          ...
          {!showAll && (
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {animatedLabels.map((label, index) => (
                  <button
                    key={label.id}
            ...
            <div className="space-y-6">
              <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                <p className="text-gray-800 dark:text-gray-200">
                  Server Status: {renderAnimatedLabel(animatedLabels[0])}
              ...
              <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                <p className="text-gray-800 dark:text-gray-200">
                  New Feature: {renderAnimatedLabel(animatedLabels[4])}
              ...
              <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                <p className="text-gray-800 dark:text-gray-200">
                  Processing: {renderAnimatedLabel(animatedLabels[2])}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              <div className="bg-white dark:bg-gray-900 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <p className="font-medium text-gray-900 dark:text-white">
                  {animatedLabels[selectedLabel].animation}
                </p>
              </div>
