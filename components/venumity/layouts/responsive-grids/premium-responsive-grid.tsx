...
import { Shield, Zap, Globe, Users, BarChart3, TrendingUp, Award, Clock } from "lucide-react";
...
export default function PremiumResponsiveGrid() {
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-12">
            <div>
              ...
              <p className="text-gray-400 max-w-2xl">
                Advanced responsive grid system with premium metrics and adaptive layouts
              </p>
            </div>
                ...
                <div className="absolute inset-0 bg-linear-to-br opacity-0 group-hover:opacity-20 transition-opacity duration-300 blur-xl rounded-2xl"
                  style={{
                    background: (() => {
                      ...
                      const from = parts[0]?.replace('from-', '#') || 'transparent';
                      const to = parts[1]?.replace('to-', '#') || 'transparent';
