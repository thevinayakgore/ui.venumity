    ...
    <nav className="relative z-1001! transform-gpu flex items-center justify-between md:px-1.5 py-1.5 sm:pt-2.5 sm:pb-2 m-auto w-full">
      ...
      <div className="flex items-center max-w-fit">
        <Link href="/" className="flex items-center gap-2 z-10 max-w-fit">
          ...
          <h2 className="hidden lg:block font-bold text-xl md:text-2xl pb-0.5">
        ...
        <Separator
          ...
          className="hidden lg:block h-7 my-auto bg-foreground/15 ml-6 mr-3"
        />
        ...
        >
          {COMPANY_SECTION.links.map((item, idx) => (
            <Link
              ...
              className="relative group/link px-3.5 py-1.75"
              href={item.href}
            >
              {hovered === idx && (
                <motion.div
                  layoutId="hovered"
                  className="absolute inset-0 h-full w-full rounded-sm bg-foreground/8"
                />
              )}
      ...
      <div className="flex items-center justify-end ml-auto gap-1.5 z-10">
        ...
        <Separator
          orientation="vertical"
          className="mx-1 h-7 my-auto bg-foreground/15"
        />

        <div className="flex items-center bg-foreground/10 rounded-md overflow-hidden w-fit">
          <Button
            size="icon"
            variant="ghost"
       className="bg-transparent!"
          ...
          <Separator
          orientation="vertical"
          className="mx-1 h-5 my-auto bg-foreground/15"
        />
