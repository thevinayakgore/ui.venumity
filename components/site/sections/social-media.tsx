...
export const socialLinks = [
  {
    ...
    description: "Star & Fork repo | Follow",
  },
  {
    name: "Twitter",
    icon: (
    ...
    description: "Interact Posts | Follow",
  },
  {
    name: "LinkedIn",
  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="icon icon-tabler icons-tabler-outline icon-tabler-brand-youtube fill-background! w-full h-full"
      >
        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
    ...
    description: "Watch Tutorials | Subscribe",
  },
  {
    name: "Instagram",
    icon: <Instagram className="w-full h-full" />,
    url: `https://www.instagram.com/${username}`,
    description: "Explore Reels | Follow",
  },
];
