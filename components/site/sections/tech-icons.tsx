...
function TechIcon({
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent className="tracking-wide font-semibold">
        <p>{label}</p>
      </TooltipContent>
    </Tooltip>
  );
  ...
  return (
    <TooltipProvider>
      <div className="not-prose flex flex-row gap-6 text-foreground">
        ...
        <TechIcon label="React" href="https://react.dev">
          <svg
            role="img"
            viewBox="0 0 32 32"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <TechIcon label="TypeScript" href="https://www.typescriptlang.org">
          <svg
            viewBox="0 0 32 32"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <TechIcon label="Tailwind CSS" href="https://tailwindcss.com">
          <svg
            role="img"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <TechIcon label="Framer Motion" href="https://motion.dev">
          <svg
            role="img"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <TechIcon label="shadcn/ui" href="https://ui.shadcn.com">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 256 256"
            className="size-5 md:size-9"
