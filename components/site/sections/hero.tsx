...
export default function Hero() {
  ...
  return (
    <section className="flex flex-col items-center justify-center m-auto p-5 md:p-10 max-w-400 w-full">
      <div className="relative z-100 flex flex-col items-center justify-center m-auto border-6 border-zinc-200 dark:border-zinc-900 bg-background shadow-xl rounded-[2rem] overflow-hidden w-full">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 z-70 transform-gpu bg-zinc-200 dark:bg-zinc-900 rounded-b-2xl h-7 w-1/4">
        ...
        <div className="flex flex-col items-center justify-center gap-5 z-70 p-5 sm:pt-10 md:pt-20 lg:pt-30 text-6xl text-center font-semibold overflow-hidden w-full">
          ...
          <TechIcons />
          <p className="text-base md:text-lg font-medium tracking-wide text-foreground/70 max-w-3xl">
          ...
          <div className="flex items-center justify-center gap-3 w-full">
            <Link href="/components">
              <Button className="group/btn pl-2! pr-5! py-5! gap-2 text-base font-semibold tracking-tight bg-linear-to-tl! from-indigo-300 via-white to-white text-black! border-4 border-indigo-500 inset-shadow-sm shadow-lg/10 transition-all duration-500 rounded-full">
                <Globe className="size-5 group-hover/btn:animate-[wiggle_0.6s_ease-in-out]" />
                Get Started
              </Button>
            </Link>
            <Link
            ...
            >
              <Button
                ...
                className="group/btn relative pl-1.5! pr-3.5! py-5! gap-2 text-base font-semibold tracking-tight bg-white! text-black! hover:text-pink-500! border-4 border-primary hover:border-pink-500 shadow-lg/10 transition-all duration-500 overflow-hidden rounded-full"
              >
                <div className="relative flex items-center justify-center size-7 bg-primary group-hover/btn:bg-pink-500 text-white rounded-full overflow-hidden">
                ...
                Contribute
                <span className="text-xl group-hover/btn:animate-[wiggle_0.6s_ease-in-out]">
                  ⏳
                </span>
              </Button>
            </Link>
        ...
        <motion.div
          className="absolute inset-x-0 -bottom-1/7 z-0 left-0 opacity-40 rounded-3xl blur-[10rem] h-100 max-w-400 m-auto w-full"
          animate={{
            background: [
